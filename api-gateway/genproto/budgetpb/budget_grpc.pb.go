...
const (
	...
	BudgetService_GetListBudget_FullMethodName = "/BudgetService/GetListBudget"
...
type BudgetServiceClient interface {
	...
	GetListBudget(ctx context.Context, in *GetListBudgetRequest, opts ...grpc.CallOption) (*GetListBudgetResponse, error)
...
func (c *budgetServiceClient) GetListBudget(ctx context.Context, in *GetListBudgetRequest, opts ...grpc.CallOption) (*GetListBudgetResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetListBudgetResponse)
	err := c.cc.Invoke(ctx, BudgetService_GetListBudget_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BudgetServiceServer interface {
	...
	GetListBudget(context.Context, *GetListBudgetRequest) (*GetListBudgetResponse, error)
...
func (UnimplementedBudgetServiceServer) GetListBudget(context.Context, *GetListBudgetRequest) (*GetListBudgetResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetListBudget not implemented")
}
...
func _BudgetService_GetListBudget_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetListBudgetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BudgetServiceServer).GetListBudget(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BudgetService_GetListBudget_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BudgetServiceServer).GetListBudget(ctx, req.(*GetListBudgetRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BudgetService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetListBudget",
			Handler:    _BudgetService_GetListBudget_Handler,
		},
		{
	...
	Metadata: "protos/budget-service/budget.proto",
}
